...
def test_search_result_list_defaults_are_independent():
    ...
    from imdbio.models import MovieBriefInfo

    movie = MovieBriefInfo(
        id="1", imdb_id="1", imdbId="tt1", title="Test", title_localized="Test"
    )
...
def test_person_detail_list_and_dict_defaults_are_independent():
    ...
    person1 = PersonDetail(
        id="1", imdb_id="1", imdbId="nm1", name="Person 1", url="url1"
    )
    person2 = PersonDetail(
        id="2", imdb_id="2", imdbId="nm2", name="Person 2", url="url2"
    )
...
def test_season_episodes_list_defaults_are_independent():
    ...
    from imdbio.models import SeasonEpisode
